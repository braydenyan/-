...
- [LibreScore](https://github.com/LibreScore/app-librescore)
...
- [OP Auto Clicker](https://www.opautoclicker.com/downloads.html)
...
- [Cave Story ~ Encore](https://csencore.com/)
- [HOME](https://gamejolt.com/games/a-new-home-off-fangame/36932)
- [Mega Man Unlimited](https://megaphilx.com/index.php/home/games/mega-man-unlimited/)
- [Mega Man Unlimited 2](https://megaphilx.com/index.php/home/games/mega-man-unlimited-2/)
- [OFF](https://www.zchr.org/off)
- [Pokémon Clover](https://poclo.net/)
- [Pokémon Close Combat](https://mizuumi.wiki/w/Pokemon:_Close_Combat/FAQ#How_do_I_install_Pokemon_Close_Combat?)
- [Pokémon Unbound](https://www.pokecommunity.com/threads/pok%C3%A9mon-unbound-completed.382178/)
- [Pokémon Uranium](https://www.reddit.com/r/pokemonuranium/comments/m9yvd6/download_links/)
...
- [Convert Case](https://addons.mozilla.org/en-US/firefox/addon/convert-case)
- [Dark Reader](https://addons.mozilla.org/en-US/firefox/addon/darkreader)
- [Enhancer for YouTube](https://addons.mozilla.org/en-US/firefox/addon/enhancer-for-youtube)
- [Load Reddit Images Directly](https://addons.mozilla.org/en-US/firefox/addon/load-reddit-images-directly)
- [Reddit Multi-Column](https://addons.mozilla.org/en-US/firefox/addon/reddit-multi-column)
- [Click to Remove Element](https://addons.mozilla.org/en-US/firefox/addon/click-to-remove-element-ff)
- [Return YouTube Dislike](https://addons.mozilla.org/en-US/firefox/addon/return-youtube-dislikes)
- [Search by Image](https://addons.mozilla.org/en-US/firefox/addon/search_by_image)
- [Showdex](https://addons.mozilla.org/en-US/firefox/addon/showdex)
- [Showdown Elo Hider](https://addons.mozilla.org/en-US/firefox/addon/pokemon-showdown-elo-hider)
...
- `www.youtube.com##ytd-rich-section-renderer:has(ytd-statement-banner-renderer)`
- `www.youtube.com##ytd-browse[page-subtype="subscriptions"] ytd-rich-item-renderer:has([aria-label="Collaboration channels"])`
